...
public class Contact {
    ...
    public Contact mergeContact(Contact contact) {
        Contact nc = new Contact(contact.name);
        nc.phones = new HashSet<>(this.phones);
        nc.emails = new HashSet<>(this.emails);
        nc.emails.addAll(contact.emails);
        nc.phones.addAll(contact.phones);
        return nc;
    }
